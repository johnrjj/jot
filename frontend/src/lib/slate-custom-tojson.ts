  ...
  switch (object) {
    case 'block':
      return {
        ...
        // isVoid: value.isVoid, (jj)seems like this is being blacklisted if undefiend
 ...
 */
export const operationJSON = (valueOriginal, options: any = {}) => {
 ...
 */
export const valueJSON = (value, options: any = {}) => {
  const object = {
    object: value.object,
